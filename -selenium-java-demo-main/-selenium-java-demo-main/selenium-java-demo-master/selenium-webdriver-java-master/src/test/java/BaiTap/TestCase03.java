...
public class TestCase03 {
    ...
    public static void Testcase03() {
        ...
        try {
            // TC03: Verify that you cannot add more product in cart than the product
            // available in store
            ...
            WebElement sonyXperiaAddToCart = driver
                    .findElement(By.xpath("//li[2]//div[1]//div[3]//button[1]//span[1]//span[1]"));
            sonyXperiaAddToCart.click();

            // Step 4: Change "QTY" value to 1000 and click "UPDATE" button. Verify the
            // error message
            ...
            WebElement emptyCartMessage = driver
                    .findElement(By.xpath("//h1[normalize-space()='Shopping Cart is Empty']"));
